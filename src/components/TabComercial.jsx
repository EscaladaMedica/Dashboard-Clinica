  ...
  return (
    <div className="spinner-wrap">
      ...
      <div className="spinner-text">
        {progress ? `Carregando conversas — pág. ${progress.page} (${progress.count})` : 'Carregando Kommo...'}
      </div>
    </div>
  );
}
        ...
        <>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div className="stat-strip">
              ...
              <StatCard variant="safe" icon="🔄" num={summary.activeLeads} label="Leads ativos"      sub="em andamento" delay={60} />
